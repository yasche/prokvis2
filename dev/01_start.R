...
##
golem::fill_desc(
  pkg_name = "prokvis2", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
...
golem::use_favicon("path/to/prelim_logo.png") # path = "path/to/ico". Can be an online file.
